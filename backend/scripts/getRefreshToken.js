...
var scope = ['read', 'history'];
// Generate the Reddit authorization URL
var authUrl = "https://www.reddit.com/api/v1/authorize?client_id=".concat(clientId, "&response_type=code&state=randomstring&redirect_uri=").concat(redirectUri, "&duration=permanent&scope=").concat(scope.join(' '));
app.get('/callback', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var code, response, data, error_1;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, fetch('https://www.reddit.com/api/v1/access_token', {
                        ...
                        body: "grant_type=authorization_code&code=".concat(code, "&redirect_uri=").concat(redirectUri)
                    })];
            case 2:
                response = _a.sent();
            ...
            case 4:
                error_1 = _a.sent();
                console.error('Error getting refresh token:', error_1);
